...
class Debug_UI(QtWidgets.QMainWindow):
    ...
    def __init__(self,debug_ui_queue=None,ui_debug_queue=None,debug_image_queue=None,image_debug_queue=None,image_queue = None,mode='mainUICall'):
        ...
        self.model.load_state_dict(
            torch.load(r'D:\zycgit\ZDevelop_Confocal\xxp_ui\20250612\load\best.pth', weights_only=False)[
                'model_state_dict'])
    ...
    def Init_hardware(self):
        try:
            ...
            self.camList[3]['cam'].MV_CC_SetFloatValue("ExposureTime", 20000)
...
# 三个相机显示
        ...
        # 将图像传递给duijiao.py进行分析
            try:
                ...
                a= self.analyzer.analyze_single_image(
                    frame,
                    use_roi=False,
